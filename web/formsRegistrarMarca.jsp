                    ...
                    <div class="card-body">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                ...
                                <form action="Registrar_marca" method="POST" role="form">

                                    <div class="form-group">
                                        <label class="control-label" for="nombremarca">Nombre de Plato</label>
                                        <input type="text" class="form-control" id="nombremarca" name="nombremarca" placeholder="Nombre de Marca">
                                    </div>
