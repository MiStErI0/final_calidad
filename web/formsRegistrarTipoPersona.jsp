        ...
        <div id="page-wrapper" class="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Registrar Tipo de Persona</li>
                </ol>
                <!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="page-header text-center">
                            Nueva Categoria de Persona
                        </h2>
                    </div>
                </div>
                <!-- /.row -->
                    ...
                    <div class="card-body">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                ...
                                <form action="Registrar_tipopersona" method="POST" role="form">

                                    <div class="form-group">
                                        <label class="control-label" for="nombretipopersona">Nombre de Categoria de Persona</label>
                                        <input type="text" class="form-control" id="nombretipopersona" name="nombretipopersona" placeholder="Nombre de Cateogoria de Persona">
                                    </div>
