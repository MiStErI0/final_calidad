                    ...
                    <div class="col-lg-6 col-lg-offset-3">
                        ...
                        <form action="Modificar_cliente" method="POST" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="idcliente" value="${param.idcliente}" disabled>
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="control-label" for="tipcli">Tipo de Cliente</label>
                                <jsp:include page="selects/tipocliente.jsp">
                                    <jsp:param name="tipcli" value="${param.tipcli}" />
                                </jsp:include>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label" for="viadomi">Via</label>
                                <jsp:include page="selects/tipovia.jsp">
                                    <jsp:param name="tipovia" value="${param.via}" />
                                </jsp:include>
                            </div>
                            ...
                            <div>
                                <button id="btnModificar" class="btn btn-primary" type="submit" name="fncliente" value="modificarCliente">Modificar</button> 
                            </div>
                        </form>
