        ...
        <div id="page-wrapper" class="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Registrar Estado de Pedido</li>
                </ol>
                <!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-12">
                ...
                <div class="card mb-3">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-6">
                            ...
                            <form action="Registrar_estadopedido" method="POST" role="form">

                                <div class="form-group">
                                    <label class="control-label" for="nombreestadopedido">Nombre de Estado de Pedido</label>
                                    <input type="text" class="form-control" id="nombreestadopedido" name="nombreestadopedido" placeholder="Nombre del Estado de Pedido" onkeypress="return soloLetras(event,this.value,100)">
                                </div>
