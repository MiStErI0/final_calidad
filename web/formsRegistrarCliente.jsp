                            ...
                            <form action="Registrar_user" method="POST" role="form">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input type="text" class="form-control" id="correoele" name="correoElectro" placeholder="Correo Electronico" onkeypress="return soloLetras(event,this.value,20)">
                                    </div>
                                </div>    
                                <div class="form-row">
                                    <div class="form-group col-lg-6">
                                ...
                                <div class="text-right">
                                    <button id="btnRegistrar" class="btn btn-primary" type="submit" name="rgusuario" value="registrarCliente">Registrar</button> 
                                </div>
                            </form>
