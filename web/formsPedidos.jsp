                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="col-md-12 text-right">
                          <button class="btn btn-primary mt-3 mb-3" data-toggle="modal" data-target="#buscarProModal" type="button">
                            <i class="fa fa-fw fa-plus"></i> Agregar Productos</button>
                        </div>
                      </div>
            ...
            <form class="mb-3" id="form-cli" method="post">
              <div class="form-row">
                <div class="col-md-6">
                  ...
                  <div class="input-group mb-2">                  
                  <input class="form-control fc-cliente mb-2" name="nombrecliente" type="text" placeholder="Ingresa nombre cliente">
                  <div class="input-group-btn">
