            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-lg-4 text-right">
                        <a href="formsRegistrarMarca.jsp" class="btn btn-secondary">Nuevo Plato</a>
                    </div>
                </div>
                <!-- /.row -->
                <div class="card mb-3">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover">
                                        <thead class="thead-light">
                                         ...
                                         <sql:query var="sqlmantenerMarcas" dataSource="${myDS}">                                        
                                            select grafe_int_id, grafe_vch_nombre from tbl_grafe_marca where grafe_int_idestado = 1                                        
                                        </sql:query> 
                                        <c:forEach var="fila" items="${sqlmantenerMarcas.rows}">
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-inline-block">
                                                        <form action="Modificar_marca" method="POST">
                                                            <input type="hidden" name="idmarca" value="${fila.grafe_int_id}">
                                                            <input type="hidden" name="nombremarca" value="${fila.grafe_vch_nombre}">
                                                            <button class="btn btn-primary btn-sm" type="submit" name="fnmarca" value="camposModificar"><i class="fa fa-edit"></i></button>
                                                        </form>
                                                    </div>   
                                                    <div class="d-inline-block">                                                   
                                                    <form action="Modificar_marca" method="POST">
                                                        <input type="hidden" name="idmarca" value="${fila.grafe_int_id}">
                                                        <button class="btn btn-danger btn-sm" type="submit" name="fnmarca" value="eliminarMarca"><i class="fa fa-trash"></i></button>
                                                    </form>
                                                    </div>
                                                </td>
                                            </tr> 
