                    ...
                    <div class="card-body">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                ...
                                <form action="Registrar_tipousuario" method="POST" role="form">

                                    <div class="form-group">
                                        <label class="control-label" for="nombretipousuario">Nombre de Tipo de usuario</label>
                                        <input type="text" class="form-control" id="nombretipousuario" name="nombretipousuario" placeholder="Nombre de tipo de usuario">
                                    </div>
