        ...
        <div id="page-wrapper" class="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Registrar Tipo de Cliente</li>
                </ol>
                <!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-12">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                ...
                                <form action="Registrar_tipocliente" method="POST" role="form">

                                    <div class="form-group">
                                        <label class="control-label" for="nombretipocliente">Nombre de Tipo de cliente</label>
                                        <input type="text" class="form-control" id="nombretipocliente" name="nombretipocliente" placeholder="Nombre de tipo de cliente">
                                    </div>
