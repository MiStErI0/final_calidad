                    ...
                    <div class="card-body">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                ...
                                <form action="Registrar_operador" method="POST" role="form">

                                    <div class="form-group">
                                        <label class="control-label" for="nombreoperador">Nombre de Operador</label>
                                        <input type="text" class="form-control" id="nombreoperador" name="nombreoperador" placeholder="Nombre de Operador">
                                    </div>
