                    ...
                    <div class="card-body">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                ...
                                <form action="Registrar_tipodocumento" method="POST" role="form">

                                    <div class="form-group">
                                        <label class="control-label" for="nombretipodocumento">Nombre de Tipo de Documento</label>
                                        <input type="text" class="form-control" id="nombretipodocumento" name="nombretipodocumento" placeholder="Nombre de tipo de producto">
                                    </div>
