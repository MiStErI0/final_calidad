        ...
        <div id="page-wrapper" class="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Registrar Tipo de Telefono</li>
                </ol>
                <!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="page-header text-center">
                            Nuevo Tipo de Telefono
                        </h2>
                    </div>
                </div>
                <!-- /.row -->
                    ...
                    <div class="card-body">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                ...
                                <form action="Registrar_tipotelefono" method="POST" role="form">

                                    <div class="form-group">
                                        <label class="control-label" for="nombretipotelefono">Nombre de Tipo de telefono</label>
                                        <input type="text" class="form-control" id="nombretipotelefono" name="nombretipotelefono" placeholder="Nombre de tipo de telefono">
                                    </div>
