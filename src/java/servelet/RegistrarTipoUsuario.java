...
public class RegistrarTipoUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(nombretipousuario != null && !nombretipousuario.isEmpty()){
            Consultas co=new Consultas();
            boolean pr = co.registrar_tipousuario(nombretipousuario);
            if(pr){
               request.setAttribute("error", false);
               RequestDispatcher rd = request.getRequestDispatcher("formsRegistrarTipoUsuario.jsp");
