...
public class RegistrarOperador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(nombreoperador != null && !nombreoperador.isEmpty()){
            ...
            boolean pr = co.registrar_operador(nombreoperador);
            if(pr){
               request.setAttribute("error", false);
               RequestDispatcher rd = request.getRequestDispatcher("formsRegistrarOperador.jsp");
